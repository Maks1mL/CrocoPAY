		...
		<div class="px-240">
			<div class="row">
				<div class="col-md-5 pb-54 align-center">
					...
					<p class="mb-0 mt-20 mt-r24 gilroy-Semibold f-20 text-white txt-center" style="display:none">
						{{ __('Download Our App') }}
					</p>
					<div class="mt-21 d-flex direction" style="display:none">
						@foreach(getAppStoreLinkFrontEnd() as $app)
							@if (!empty($app->logo))
								<a href="{{ $app->link }}" target="_blank" >
									<img style="display:none" class="{{ $app->company == 'Apple' ?  'ms-3 ml-r12' : '' }}app-imgs" src="{{ url('public/uploads/app-store-logos/thumb/'.$app->logo) }}" alt="{{ __('playstore') }}">
								</a>
							@else
								<a href="javascript:void(0)">
									<img style="display:none" class="app-imgs" src="{{ url('public/uploads/app-store-logos/default-logo.jpg') }}">
								</a>
							@endif
						@endforeach
				...
				<div class="col-md-3 align-center">
					...
					<div class="mt-18">
						<ul class="links gilroy-light">
							...
							<li><a href="{{ url('/privacy-policy') }}" class="poppins5">{{ __('Privacy Policy') }}</a></li>
						</ul>
					</div>
				</div>
				<div class="col-md-4 align-center">
					<div class="custom-postion">
						...
						<ul class="links gilroy-light">
						<li><a href="https://t.me/CrocoPay">Telegram: @CrocoPay</a></li>
						<li><a href="mailto:manager@crocopay.app">manager@crocopay.app</a></li>
						<li><a href="https://crocopay.app/tickets">Служба поддержки</a></li>
						</ul>
