<!-- navbar -->
    <div style="padding:0" class="navigation-wrap bg-white start-header start-style {{ request()->is('login') || request()->is('forget-password') || request()->is('password/resets/*') || request()->is('register') || request()->is('register/store-personal-info') || request()->is('2fa') || request()->is('google2fa') ? 'd-none' : '' }}">
		<div class="container-fluid px-240">
			<div class="row">
				<div class="col-12">
					<nav class="navbar navbar-expand-md navbar-light">
						<a class="navbar-brand" href="{{ request()->path() != 'merchant/payment' ? url('/') : 'javascript:void(0)' }}">
							<img height="80" src="img/logo.png" alt="{{ __('Brand Logo') }}"><!--{{ image(settings('logo'), 'logo') }}-->
                        </a>	
						...
						<div class="collapse navbar-collapse" id="navbarSupportedContent">
							<ul class="navbar-nav ms-auto py-4 py-md-0 gilroy-medium nav-align">
                                ...
                                <li style="display:none" class="nav-item {{ isset( $menu ) && ( $menu == 'privacy-policy' ) ? 'nav-active': '' }}">
